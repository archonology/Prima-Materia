...
const from = (_i) => ({ x: -1000, rot: 0, scale: 1.5, y: -1000 });
        ...
        <Grid item xs={8}>
          ...
          >
            <Typography sx={{ fontSize: "18px", paddingTop: "2em" }}>
              Prima Materia is a site dedicated to fans of Magic The Gathering.
              You can search for cards, add cards to a wishlist, and create
              virtual decks. Login or sign up to get started!
            </Typography>
          </Box>
        </Grid>
      </Grid>
